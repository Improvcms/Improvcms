  ...
  $.fn.extend({ 
    ...
    AeroWindow: function(options) {
      ...
      return this.each(function() {
		...
		var WinBackBtn = '<a href="javascript:history.back()" class="win-back-btn"></a><div class="win-btn-spacer"></div>';
		var WinForwardBtn = '<a href="javascript:history.forward()" class="win-forward-btn"></a><div class="win-btn-spacer"></div>';
        ...
        //Closable button for the window...
        if (o.WindowClosable) {
