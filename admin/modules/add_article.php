...
<title>Add an Article | MillionCMS ACP</title>
...
<div id="wrapper">
    ...
    <div id="million_menu_wrapper">
    	<div id="main_menu">
			<ul>
				...
				<li><a href="add_article.php" class="selected"><span><span>Articles &amp; Categories</span></span></a></li>
        ...
        <div id="sec_menu">
			<ul>
				<li><a href="add_article.php" class="add_article">Add a New Article</a></li>
                <li><a href="#" class="manage_articles">Manage Articles</a></li>
                <li><a href="#" class="article_settings">Article Setting</a></li>
                <li><a href="#" class="new_cat">Add a New Category</a></li>
                <li><a href="#" class="manage_cat">Manage Categories</a></li>
                <li><a href="#" class="manage_sections">Manage Sections</a></li>
                <li><a href="#" class="cat_settings">Category Settings</a></li>
                <li><a href="#" class="article_trash">Article Trash</a></li>
                <li><a href="#" class="front_page_settings">Front Page Settings</a></li>
			</ul>
		</div>
    </div>
    <div id="content" style="padding-bottom:50px;"><img src="../images/content_top.png" width="100%" height="1px" />
		...
		<div id="sidebar">
        	<div class="contentcontainer">  
                ...
                <div class="contentcontainer">
                    ...
                    <div class="contentbox">
                    	Here, you can create a new article. When you accept the article, you can go into the article manager page to manage it, and also other article's you have made before.
                    </div>
                </div>
                <div class="contentcontainer">               
        ...
        <div id="main_content">   
        	...
        	<div class="contentcontainer">
            	<div class="headings">
                	<h2>Admin Control Panel - Add an Article</h2>
                </div>                
                <div class="contentbox">
                	<form>
