...
<title>SQL Injector | MillionCMS ACP</title>
...
<div id="wrapper">
    ...
    <div id="content" style="padding-bottom:50px;"><img src="../images/content_top.png" width="100%" height="1px" />
        ...
        <div id="main_content">   
        	...
        	<div class="contentcontainer">
            	<div class="headings">
                	<h2>Admin Control Panel - SQL Injector Service</h2>
                </div>                
                <div class="contentbox">
                	...
                	<form action="core/settings_insert.php" method="post" name="user_settings">
                    	<table>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><span class='title_text'>Message Box:</span></td>
                                <td><input style="width:50%" type="text" value="SQL Injector Service has Ended. Unable to Start/Offline." /></td>
                              </tr>
                            
                              <tr>
                                <td><span class='title_text'>Injector Switch:</span></td>
                                <td>
                                    <input type="image" src="../icons/tick.png" />
			  						<input type="image" src="../icons/cross.png" />
                                </td>
                              </tr>
                        ...
                        <table>
                            <thead>
                              <tr>                    
                                <th width="25%">Injector Box</th>
                                <th width="75%">Place your SQL code in this box, but be warned; there is no undo switch!</th>
                              </tr>
                            </thead>
                            ...
                            <tbody>
                              <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <textarea name="sql_inject" id="sql_inject" style="width:50%; height:200px;" ></textarea>
                                </td>
                              </tr>
                                                 	
                            </tbody>
                        </table>
                        <div style="text-align:center;"><br /><input style="width:250px;" name="submit" type="submit" value="Inject this Direct SQL Code" /></div>
                    </form>
                </div>
            </div>            
