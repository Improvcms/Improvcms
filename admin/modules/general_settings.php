...
<title>General Settings | MillionCMS ACP</title>
		...
		<div id="sidebar">
        	<div class="contentcontainer">  
                ...
                <div class="contentcontainer">
                    ...
                    <div class="contentbox">
                    	On this page, you will find the General Setting's for your website. The settings here go from turning your site on or off, to changing the favicon all over your website.
                        <br /><br />
                        All settings on this page are safe to edit, and will not cause safty issue's if you change them. The email here is kept in the database, and can not be accessed outside of the ACP.
                    </div>
                </div>
