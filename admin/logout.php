...
// Remove the session.
$db->query("UPDATE ".TABLE_PREFIX."users SET adminsession='0' WHERE uid='{$mcms->user['uid']}'");
...
<body>
	...
	<div class="block">
		...
		<center><a href="<?php echo $mcms->settings['homeurl'] ?>"><img src="images/logo.png" alt="" width="312" height="600" /></a><br /></center>
